...
def stringify_tool_call_results(tool_call_result: dict) -> str:
    """
    TODO: Format tool call results to a pretty string for the final output
    """
    pass
...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        # Create session that handles MCP requests/responses
    ...
    async def process_query(self, query: str):
        ...
        # Reference: https://platform.openai.com/docs/api-reference/chat/object#chat/object-choices
        ...
        if finish_reason == "stop": # plain text response
            """
            TODO: Handle plain text response
            """
            pass 

        elif finish_reason == "tool_calls": # tool call response
            ...
            for tool_call in tool_calls:
                ...
                """
                TODO: Format tool call results for the final output
                """
            ...
            final_text.append(str(response.choices[0].message.content)) # Hint: think about the edge case!
